...
# wget https://scripts.hostarts.com/master.sh && sudo bash master.sh

# Variables for URLs and script info
this_script_url="https://scripts.hostarts.com/master.sh"
this_script_name="Master Scripter Repo"
...
github_username="hostarts"
github_repo_name="scripter"
